 ...
 * ricercaPuntualeMovimentiCapitoloUscitaPrevisione()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class RicercaPuntualeMovimentiCapitoloUscitaPrevisioneResponse extends
		ServiceResponse {
	...
	public void setListaVincoli(List<VincoloCapitoli> list) {
		this.listaVincoli = list;
	}
