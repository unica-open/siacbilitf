...
public class RicercaPuntualeCapitoloEntrataGestione extends ServiceRequest {

	private Ente ente;
	private RicercaPuntualeCapitoloEGest ricercaPuntualeCapitoloEGest;
	...
	public RicercaPuntualeCapitoloEGest getRicercaPuntualeCapitoloEGest() {
		return ricercaPuntualeCapitoloEGest;
	}

	public void setRicercaPuntualeCapitoloEGest(
			RicercaPuntualeCapitoloEGest ricercaPuntualeCapitoloEGest) {
		this.ricercaPuntualeCapitoloEGest = ricercaPuntualeCapitoloEGest;
	}
