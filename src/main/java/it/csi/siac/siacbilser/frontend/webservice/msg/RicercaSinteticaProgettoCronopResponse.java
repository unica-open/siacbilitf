...
public class RicercaSinteticaProgettoCronopResponse extends ServiceResponse {
	...
	public void setProgetti(ListaPaginata<Progetto> listaProgetto) {
		this.progetti = listaProgetto;
	}
