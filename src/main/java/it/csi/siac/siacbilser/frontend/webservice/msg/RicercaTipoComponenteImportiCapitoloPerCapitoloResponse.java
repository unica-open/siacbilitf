...
public class RicercaTipoComponenteImportiCapitoloPerCapitoloResponse extends ServiceResponse {
	 ...
	 */
	public void setListaTipoComponenteImportiCapitolo(
			List<TipoComponenteImportiCapitolo> listaTipoComponenteImportiCapitolo) {
