...
/**
 * Client del servizio Bilancio CapitoloEntrataGestioneService
 * 
 * @author rmontuori
 * @deprecated utilizzare l'instanaziazione via Spring
 */
@Deprecated
public class CapitoloEntrataGestioneServiceClient extends BaseServiceClient{

	private CapitoloEntrataGestioneService port;
	
	public CapitoloEntrataGestioneServiceClient(){
		super();
	}
	...
	private void createService() {
		try {
			...
			port = service.getPort(CapitoloEntrataGestioneService.class);
	...
	public CapitoloEntrataGestioneService getPort() {
		if (service==null)
			createService();
		return port;
	}
