...
public class InserisceCapitoloDiUscitaPrevisione extends ServiceRequest {
...
//	private Macroaggregato macroaggregato;
	...
	public void setCapitoloUscitaPrevisione(CapitoloUscitaPrevisione c)  {		
...
//		this.ente = ente;
		...
		this.getCapitoloUscitaPrevisione().setEnte(ente);
	}
...
//		this.classificatoriGenerici = listaClassificatoriGenerici;
		getCapitoloUscitaPrevisione().setClassificatoriGenerici(listaClassificatoriGenerici);
	}
...
//		return classificazioneCofogProgramma;
	...
	public void setClassificazioneCofogProgramma(
			ClassificazioneCofogProgramma classCofogProgramma) {
//		this.classificazioneCofogProgramma = classCofogProgramma;
		getCapitoloUscitaPrevisione().setClassificazioneCofogProgramma(classCofogProgramma);
	}
...
//		return importiCapitoloUP;
	...
	public void setImportiCapitoloUP(List<ImportiCapitoloUP> importiCapitoloUP) {
//		this.importiCapitoloUP = importiCapitoloUP;
		getCapitoloUscitaPrevisione().setListaImportiCapitoloUP(importiCapitoloUP);
	}
