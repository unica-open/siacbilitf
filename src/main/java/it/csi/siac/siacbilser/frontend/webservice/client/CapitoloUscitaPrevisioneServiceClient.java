...
/**
 * Client del servizio Bilancio CapitoloUscitaPrevisioneService
 * 
 * @author rmontuori
 * @deprecated utilizzare l'instanaziazione via Spring
 */
@Deprecated
public class CapitoloUscitaPrevisioneServiceClient extends BaseServiceClient{

	private CapitoloUscitaPrevisioneService port;
	
	public CapitoloUscitaPrevisioneServiceClient(){
		super();
	}
	...
	private void createService() {
		try {
			...
			port = service.getPort(CapitoloUscitaPrevisioneService.class);
	...
	public CapitoloUscitaPrevisioneService getPort() {
		if (service==null)
			createService();
