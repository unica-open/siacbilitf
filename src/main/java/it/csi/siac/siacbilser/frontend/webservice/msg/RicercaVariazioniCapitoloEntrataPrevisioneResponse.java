...
/**
 * Risposta al metodo BIL.CapitoloEntrataPrevisioneService.ricercaVariazioniCapitoloEntrataPrevisione()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class RicercaVariazioniCapitoloEntrataPrevisioneResponse extends ServiceResponse {
