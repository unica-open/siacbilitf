...
/**
 * Richiesta al metodo BIL.CapitoloUscitaPrevisioneService.ricercaPuntualeMovimentiCapitoloUscitaPrevisione()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class RicercaPuntualeMovimentiCapitoloUscitaPrevisione extends
		ServiceRequest {
