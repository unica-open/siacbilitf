...
/**
 * Risposta al metodo BIL.CapitoloUscitaGestioneService.ricercaVariazioniCapitoloUscitaGestione()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class RicercaVariazioniCapitoloUscitaGestioneResponse extends ServiceResponse {
