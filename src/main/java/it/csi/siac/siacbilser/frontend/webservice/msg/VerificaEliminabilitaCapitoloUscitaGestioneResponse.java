...
/**
 * Risposta al metodo BIL.CapitoloUscitaGestioneService.
 * verificaEliminabilitaCapitoloUscitaGestione()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class VerificaEliminabilitaCapitoloUscitaGestioneResponse extends
		ServiceResponse {
