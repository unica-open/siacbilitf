...
/**
 * Richiesta al metodo BIL.FondiDubbiaEsigibilitaService.ricercaDettaglioAccantonamentoFondiDubbiaEsigibilitaAttributiBilancio()
 * 
 * @author Alessandro Marchino
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class RicercaDettaglioAccantonamentoFondiDubbiaEsigibilitaAttributiBilancio extends ServiceRequest {
