...
/**
 * Richiesta al metodo BIL.CapitoloUscitaPrevisioneService.annullaCapitoloUscitaPrevisione()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class AnnullaCapitoloUscitaPrevisione extends ServiceRequest {
