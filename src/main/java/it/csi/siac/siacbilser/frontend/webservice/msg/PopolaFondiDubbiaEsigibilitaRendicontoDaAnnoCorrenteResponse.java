...
public class PopolaFondiDubbiaEsigibilitaRendicontoDaAnnoCorrenteResponse 
	extends BasePopolaFondiDubbiaEsigibilitaResponse<AccantonamentoFondiDubbiaEsigibilitaRendiconto> {
	// Nothing to add
}
