...
public class RicercaDettaglioMassivaCapitoloEntrataGestioneResponse extends ServiceResponse {
	...
	public void setCapitoloMassivaEntrataGestione(
			CapitoloMassivaEntrataGestione capitoloMassivaEntrataGestione) {
