...
/**
 * Richiesta al metodo BIL.FondiDubbiaEsegibilitaService.aggiornaFondoDubbiaEsegibilita()
 * 
 * @author Alessandro Marchino
 * 
 */
@XmlType(namespace = BILSvcDictionary.NAMESPACE)
public class AggiornaFondoDubbiaEsigibilitaRendiconto extends ServiceRequest {
