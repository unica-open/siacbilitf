...
public class VariazioneImportoCapitoloReport extends ExcelReport {
...
//	private String variazioneAnno;
	...
	public Map<VariazioneImportoCapitoloReportCampiColonne, Object> getCampi() {
		return getAsMap(VariazioneImportoCapitoloReportCampiColonne.values());
	}
	/**
