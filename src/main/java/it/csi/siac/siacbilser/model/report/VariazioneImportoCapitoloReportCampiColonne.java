 ...
 *
 */
public enum VariazioneImportoCapitoloReportCampiColonne implements ReportColumn{
...
//	ANNO_VARIAZIONE(           "Anno Competenza",                       "variazioneAnno",                           String.class),
	 ...
	 */
	private VariazioneImportoCapitoloReportCampiColonne(String columnName, String fieldName, Class<?> columnType) {
	 ...
	 * @return the colonne
	 */
	public static List<ReportColumn> getColonne(){
		final List<ReportColumn> colonne = new ArrayList<ReportColumn>();
		for (VariazioneImportoCapitoloReportCampiColonne variazioneImportoCapitoloReportCampiColonne : VariazioneImportoCapitoloReportCampiColonne.values()) {
			colonne.add(variazioneImportoCapitoloReportCampiColonne);
		}
		return colonne;
	}
