...
@WebService(targetNamespace = INTEGSvcDictionary.NAMESPACE, name = "DocumentiFinanziariFlussiEsterniService")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@BindingType(javax.xml.ws.soap.SOAPBinding.SOAP12HTTP_BINDING)
@XmlSeeAlso(ElaboraFile.class)
public interface DocumentiFinanziariFlussiEsterniService extends ElaboraFileService {
	/**
	 * Esecuzione del flusso documenti finanziari
