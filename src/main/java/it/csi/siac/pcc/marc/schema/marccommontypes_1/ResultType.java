 ...
 *       &lt;sequence>
 *         &lt;element name="Codice" type="{http://www.csi.it/marc/schema/MarcCommonTypes-1.0}CodiceEsitoType"/>
...
public class ResultType {
    ...
    public ResultType() {
		// empty constructor needded
	}
    
    public ResultType(String codice, String messaggio) {
    	this.codice = codice;
