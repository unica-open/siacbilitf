 ...
 * generated in the it.csi.siac.sirfelser.frontend.webservice.msg.inviofatturapa.services.model package. 
 ...
 */
@XmlRegistry
public class ObjectFactoryModelInvioFat {

    private static final QName _FatturaElettronica_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2", "FatturaElettronica");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.csi.siac.sirfelser.frontend.webservice.msg.inviofatturapa.services.model
     * 
     */
    public ObjectFactoryModelInvioFat() {
