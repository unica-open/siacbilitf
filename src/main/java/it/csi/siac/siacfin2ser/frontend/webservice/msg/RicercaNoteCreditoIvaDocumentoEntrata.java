...
public class RicercaNoteCreditoIvaDocumentoEntrata extends ServiceRequest {
	 ...
	 */
	public void setDocumentoEntrata(DocumentoEntrata documentoSpesa) {
		this.documentoEntrata = documentoSpesa;
	}
