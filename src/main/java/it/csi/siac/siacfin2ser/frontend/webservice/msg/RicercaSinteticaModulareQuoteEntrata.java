...
public class RicercaSinteticaModulareQuoteEntrata extends RicercaSinteticaBaseRequest {
	
	private SubdocumentoEntrata subdocumentoEntrata;
	private boolean requireTotale = false;
	...
	public SubdocumentoEntrata getSubdocumentoEntrata() {
		return this.subdocumentoEntrata;
	}
	/**
	...
	/**
	 * @return the requireTotale
	 */
	public boolean isRequireTotale() {
		return this.requireTotale;
	}
	/**
	 * @param requireTotale the requireTotale to set
	 */
	public void setRequireTotale(boolean requireTotale) {
		this.requireTotale = requireTotale;
	}
	/**
