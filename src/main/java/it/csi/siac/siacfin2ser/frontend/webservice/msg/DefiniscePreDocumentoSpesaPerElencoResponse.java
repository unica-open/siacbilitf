...
public class DefiniscePreDocumentoSpesaPerElencoResponse extends ServiceResponse {

	@XmlElementWrapper(name="predocumentiCompletati")
	@XmlElement(name="predocumento")
	private List<PreDocumentoSpesa> predocumentiCompletati = new ArrayList<PreDocumentoSpesa>();
	 ...
	 */
	@XmlTransient
	public List<PreDocumentoSpesa> getPredocumentiCompletati() {
		return predocumentiCompletati;
	}
	/**
	 * @param predocumentiCompletati the predocumentiCompletati to set
	 */
	public void setPredocumentiCompletati(List<PreDocumentoSpesa> predocumentiCompletati) {
