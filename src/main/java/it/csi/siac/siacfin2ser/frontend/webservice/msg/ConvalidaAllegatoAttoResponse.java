...
public class ConvalidaAllegatoAttoResponse extends ServiceResponse {
	...
	private Long countQuoteConvalidate = Long.valueOf(0);
	
	private List<Messaggio> messaggi = new ArrayList<Messaggio>();
	
	public void incCountQuoteConvalidate() {
		countQuoteConvalidate++;
	}

	/**
	 * @return the countQuoteConvalidate
	 */
	public Long getCountQuoteConvalidate() {
		return countQuoteConvalidate;
	}

	/**
	 * @param countQuoteConvalidate the countQuoteConvalidate to set
	 */
	public void setCountQuoteConvalidate(Long countQuoteConvalidate) {
		this.countQuoteConvalidate = countQuoteConvalidate;
	}
	...
	public boolean sonoPresentiQuoteScartate() {
		return !getSubdocumentiScartati().isEmpty() 
				 || !getElenchiScartati().isEmpty();
	}
