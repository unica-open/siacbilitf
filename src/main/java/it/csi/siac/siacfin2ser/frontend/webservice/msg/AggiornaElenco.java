...
public class AggiornaElenco extends ServiceRequest {

	//serve?
	private Bilancio bilancio;
	private ElencoDocumentiAllegato elencoDocumentiAllegato;
	//AllegatoAtto a cui e' associato l'ElencoDocumentiAllegato, se null l'elenco viene scollegato dall'AllegatoAtto (se c'era un legame)
