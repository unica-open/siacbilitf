...
public class EmetteOrdinativoDiIncassoSingolo extends ServiceRequest {
	 ...
	 * @return the subdoc
	 */
	public SubdocumentoEntrata getSubdoc() {
		return subdoc;
	}
	 ...
	 */
	public void setSubdoc(SubdocumentoEntrata subdoc) {
		this.subdoc = subdoc;
	}
