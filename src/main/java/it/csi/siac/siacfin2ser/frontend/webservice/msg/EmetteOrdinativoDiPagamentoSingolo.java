...
public class EmetteOrdinativoDiPagamentoSingolo extends ServiceRequest {
	 ...
	 * @return the subdoc
	 */
	public SubdocumentoSpesa getSubdoc() {
		return subdoc;
	}
	/**
	 * @param subdoc the subdoc to set
	 */
	public void setSubdoc(SubdocumentoSpesa subdoc) {
		this.subdoc = subdoc;
	}
	...
	/**
	 * Gets the bilancio anno successivo.
	 *
	...
	/**
	 * Sets the bilancio anno successivo.
	 *
	 * @param bilancioAnnoSuccessivo the new bilancio anno successivo
	 */
