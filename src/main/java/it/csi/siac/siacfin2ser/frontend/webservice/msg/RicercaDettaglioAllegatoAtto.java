...
public class RicercaDettaglioAllegatoAtto extends ServiceRequest {
	//un atto amministrativo puo' avere al piu' un solo AllegatoAtto
	private AttoAmministrativo attoAmministrativo;
	//in opzione a AttoAmministrativo si puo' indicare direttamente la chiave di AllegatoAtto
	private AllegatoAtto allegatoAtto;
	
	private AllegatoAttoModelDetail[] allegatoAttoModelDetails;
	
	@XmlElementWrapper(name="modelDetailsEntitaCollegate")
	@XmlElements({
