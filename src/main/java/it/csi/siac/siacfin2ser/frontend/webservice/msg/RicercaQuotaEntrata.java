...
public class RicercaQuotaEntrata extends ServiceRequest {
	...
	private Integer uidProvvediemento;
	...
	private Boolean importoDaIncassareZero;
	...
	/**
	 * Gets the importo da incassare zero.
	 *
	 * @return the importoDaIncassareZero
	 */
	public Boolean getImportoDaIncassareZero() {
		return importoDaIncassareZero;
	}
	
	/**
	 * Sets the importo da incassare zero.
	 *
	 * @param importoDaIncassareZero the importoDaIncassareZero to set
	 */
	public void setImportoDaIncassareZero(Boolean importoDaIncassareZero) {
		this.importoDaIncassareZero = importoDaIncassareZero;
	}
	...
	/**
	 * @return the uidProvvediemento
	 */
	public Integer getUidProvvediemento() {
		return uidProvvediemento;
	}

	/**
	 * @param uidProvvediemento the uidProvvediemento to set
	 */
	public void setUidProvvediemento(Integer uidProvvediemento) {
		this.uidProvvediemento = uidProvvediemento;
	}
