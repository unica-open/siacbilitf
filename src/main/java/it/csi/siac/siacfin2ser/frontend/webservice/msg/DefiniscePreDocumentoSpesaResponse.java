...
public class DefiniscePreDocumentoSpesaResponse extends ServiceResponse {

	@XmlElementWrapper(name="predocumentiElaborati")
	@XmlElement(name="predocumento")
	private List<PreDocumentoSpesa> predocumentiElaborati = new ArrayList<PreDocumentoSpesa>();
	@XmlElementWrapper(name="predocumentiSaltati")
	@XmlElement(name="predocumento")
	private List<PreDocumentoSpesa> predocumentiSaltati = new ArrayList<PreDocumentoSpesa>();
	 ...
	 */
	@XmlTransient
	public List<PreDocumentoSpesa> getPredocumentiElaborati() {
		return predocumentiElaborati;
	}
	/**
	 * @param predocumentiElaborati the predocumentiElaborati to set
	 */
	public void setPredocumentiElaborati(List<PreDocumentoSpesa> predocumentiElaborati) {
		this.predocumentiElaborati = predocumentiElaborati != null ? predocumentiElaborati : new ArrayList<PreDocumentoSpesa>();
	}
	/**
	 * @return the predocumentiSaltati
	 */
	@XmlTransient
	public List<PreDocumentoSpesa> getPredocumentiSaltati() {
		return predocumentiSaltati;
	}
	/**
	 * @param predocumentiSaltati the predocumentiSaltati to set
	 */
	public void setPredocumentiSaltati(List<PreDocumentoSpesa> predocumentiSaltati) {
		this.predocumentiSaltati = predocumentiSaltati != null ? predocumentiSaltati : new ArrayList<PreDocumentoSpesa>();
	}
	/**
	 * @return the messaggi
	 */
