...
public final class CostantiFin {
	...
	public static AttributoMovimentoGestione attributoMovimentoGestioneStringToEnum(String code){
		...
		//SIAC-6997
		}else if(AttributoMovimentoGestione. flagDaReanno.name().equalsIgnoreCase(codeTrimmed)){
			return AttributoMovimentoGestione. flagDaReanno;
		...
		}else if(AttributoMovimentoGestione.annoPrenotazioneOrigine.name().equalsIgnoreCase(codeTrimmed)){
			return AttributoMovimentoGestione.annoPrenotazioneOrigine; 
		}else if(AttributoMovimentoGestione.codVerbaleAccertamento.name().equalsIgnoreCase(codeTrimmed)) {
			return AttributoMovimentoGestione.codVerbaleAccertamento;
		}
	...
	//SIAC-6997
	public static final String T_ATTR_CODE_FLAG_DA_REANNO="flagDaReanno";
	public static final String T_ATTR_CODE_FLAG_SOGGETTO_DURC="flagSoggettoDurc"; 
	//SIAC-6865
	public static final String T_ATTR_CODE_ANNO_PRENOTAZIONE_ORIGINE="annoPrenotazioneOrigine"; 
	...
	//SIAC-8178
	public static final String T_ATTR_CODE_VERB_ACCERTAMENTO="codVerbaleAccertamento";
	...
	public static StatoOperativoModificaMovimentoGestione statoOperativoModificaMovimentoGestioneStringToEnum(String code){
		if(CostantiFin.D_MODIFICA_STATO_VALIDO.equals(code)){
			return StatoOperativoModificaMovimentoGestione.VALIDO;
		} else if(CostantiFin.D_MODIFICA_STATO_ANNULLATO.equals(code)){
	...
	public static StatoOperativoLiquidazione statoOperativoLiquidazioneStringToEnum(String code){
		if(CostantiFin.D_LIQUIDAZIONE_STATO_VALIDO.equals(code)){
			return StatoOperativoLiquidazione.VALIDO;
		} else if(CostantiFin.D_LIQUIDAZIONE_STATO_ANNULLATO.equals(code)){
			return StatoOperativoLiquidazione.ANNULLATO;
		} else if(CostantiFin.D_LIQUIDAZIONE_STATO_PROVVISORIO.equals(code)){
	...
	public static String statoOperativoLiquidazioneEnumToString(StatoOperativoLiquidazione stato) {
		...
		if (stato != null) {
			if (StatoOperativoLiquidazione.PROVVISORIO.name().equalsIgnoreCase(stato.name())) {
				codifica = CostantiFin.D_LIQUIDAZIONE_STATO_PROVVISORIO;
			} else if (StatoOperativoLiquidazione.VALIDO.name().equalsIgnoreCase(stato.name())) {
				codifica = CostantiFin.D_LIQUIDAZIONE_STATO_VALIDO;
			} else if (StatoOperativoLiquidazione.ANNULLATO.name().equalsIgnoreCase(stato.name())) {
				codifica = CostantiFin.D_LIQUIDAZIONE_STATO_ANNULLATO;
			} 
		}
		return codifica;
	}
	...
	public static StatoOperativoOrdinativo statoOperativoOrdinativoStringToEnum(String code){
		...
		if(CostantiFin.D_ORDINATIVO_STATO_INSERITO.equals(code)){
			return StatoOperativoOrdinativo.INSERITO;
		} else if(CostantiFin.D_ORDINATIVO_STATO_TRASMESSO.equals(code)){
			return StatoOperativoOrdinativo.TRASMESSO;
		} else if(CostantiFin.D_ORDINATIVO_STATO_FIRMATO.equals(code)){
			return StatoOperativoOrdinativo.FIRMATO;
		} else if(CostantiFin.D_ORDINATIVO_STATO_QUIETANZATO.equals(code)){
			return StatoOperativoOrdinativo.QUIETANZATO;
		}else if(CostantiFin.D_ORDINATIVO_STATO_ANNULLATO.equals(code)){
	...
	public static TipoAssociazioneEmissione tipoAssociazioneEmissioneStringToEnum(String code){
		...
		if(CostantiFin.D_ORDINATIVO_SUBORDINATO.equals(code)){
			return TipoAssociazioneEmissione.SUB_ORD;
		} else if(CostantiFin.D_ORDINATIVO_SUBORDINATO_RITENUTE.equals(code)){
			return TipoAssociazioneEmissione.RIT_ORD;
		} else if(CostantiFin.D_SOSTITUZIONE_ORDINATIVO.equals(code)){
			return TipoAssociazioneEmissione.SOS_ORD;
		} else if(CostantiFin.D_ORDINATIVO_SPLIT_REVERSE.equals(code)){
			return TipoAssociazioneEmissione.SPR;
		} else if(CostantiFin.D_ORDINATIVO_REINTROITI.equals(code)){
...
//		if(CostantiFin.D_ORDINATIVO_COMMISSIONE_TIPO_BENEFICIARIO.equals(code)){
//			return CommissioneDocumento.BN;
//		} else if(CostantiFin.D_ORDINATIVO_COMMISSIONE_TIPO_ESENTE.equals(code)){
//			return CommissioneDocumento.ES;
//		}  else if(CostantiFin.D_ORDINATIVO_COMMISSIONE_TIPO_CARICO_ENTE.equals(code)){
...
//	}
	...
	public static TipoProvvisorioDiCassa tipoProvvisorioDiCassaStringToEnum(String code){
		if(CostantiFin.D_PROV_CASSA_TIPO_SPESA.equals(code)){
			return TipoProvvisorioDiCassa.S;
		} else if(CostantiFin.D_PROV_CASSA_TIPO_ENTRATA.equals(code)){
	...
	public static String tipoProvvisorioDiCassaEnumToString(TipoProvvisorioDiCassa tipoProvvisorioDiCassa) {
		...
		if (tipoProvvisorioDiCassa != null) {
			if (TipoProvvisorioDiCassa.S.name().equalsIgnoreCase(tipoProvvisorioDiCassa.name())) {
				codifica = CostantiFin.D_PROV_CASSA_TIPO_SPESA;
			} else if (TipoProvvisorioDiCassa.E.name().equalsIgnoreCase(tipoProvvisorioDiCassa.name())) {
				codifica = CostantiFin.D_PROV_CASSA_TIPO_ENTRATA;
			} 
		}
		return codifica;
	}
...
//			ta = TipoAccredito.CO;
	...
	public static StatoOperativoCartaContabile statoOperativoCartaContabileStringToEnum(String code){
		if(CostantiFin.D_CARTA_CONTABILE_STATO_PROVVISORIO.equals(code)){
			return StatoOperativoCartaContabile.PROVVISORIO;
		} else if(CostantiFin.D_CARTA_CONTABILE_STATO_ANNULLATO.equals(code)){
			return StatoOperativoCartaContabile.ANNULLATO;
		} else if(CostantiFin.D_CARTA_CONTABILE_STATO_COMPLETATO.equals(code)){
			return StatoOperativoCartaContabile.COMPLETATO;
		} else if(CostantiFin.D_CARTA_CONTABILE_STATO_TRASMESSO.equals(code)){
