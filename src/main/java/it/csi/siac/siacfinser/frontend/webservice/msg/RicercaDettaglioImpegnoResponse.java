...
/**
 * Risposta al metodo FIN.movimentoGestioneService.ricercaDettaglioImpegno()
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = FINSvcDictionary.NAMESPACE)
public class RicercaDettaglioImpegnoResponse extends RicercaAttributiMovimentoGestioneResponse {
