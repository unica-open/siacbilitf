...
/**
 * Annulla il legame che un soggetto ha con altri soggetti censiti in archivio.
 * Il legame &eacute; dal soggetto a uno o pi&ugrave; dei suoi precedenti. 
 * 
 * @author 
 * 
 */
@XmlType(namespace = FINSvcDictionary.NAMESPACE)
public class AnnullaLegameSoggetti extends AbstractSoggettoServiceRequest {
