...
/**
 * Tutti i campi presenti in ParametroRicercaCartaContabile
 * @author andrea.colombo
 *
 */
@XmlType(namespace = FINDataDictionary.NAMESPACE)
public class ParametroRicercaCartaContabile implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7600691055753020368L;
