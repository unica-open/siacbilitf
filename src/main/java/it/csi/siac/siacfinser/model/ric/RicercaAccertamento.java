...
/**
 * Parametri per la ricerca degli accertamenti
 * 
 * @author rmontuori
 * 
 */
@XmlType(namespace = FINDataDictionary.NAMESPACE)
public class RicercaAccertamento implements Serializable {

	private static final long serialVersionUID = -4299960651537556486L;
